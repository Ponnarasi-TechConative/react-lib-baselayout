...
const result = configBuilder(
  ...
  },
  {
    ...
    plugins: [
      ...
      new WebpackBundleSizeAnalyzerPlugin("log.bundle-sizes.sample-import-ui.txt"),
      // new StatsWriterPlugin({
      //   filename: path.join("log.bundle-stats.sample-import-ui.json"),
      //   fields: null,
      // }),
    ],
  }
